...
(function () {
  ...
  const ARROW = '<svg viewBox="0 0 24 24" fill="none" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M13 6l6 6-6 6"/></svg>';
      ...
      <div class="view">
        <section class="hero">
          ...
          <button class="search-trigger" id="open-search">
            ...
            Search 225 bottles, flavors, cocktails…
          </button>
        </section>
